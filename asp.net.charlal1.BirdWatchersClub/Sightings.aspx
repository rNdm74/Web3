...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="table">        
          <asp:Panel ID="Pan1" BackColor="White" ScrollBars="Auto" runat="server" HorizontalAlign="Justify" CssClass="panel">    
            <h1><asp:Label ID="lSelectedGridView" runat="server" Text=""></asp:Label>&nbsp; </asp:Label></h1><br />
            <%--<hr /> --%>       
    ...
    <div class="footer">
        <h3><asp:RadioButtonList ID="rblGridView" runat="server" style="display: block; position:absolute; left: 25px; right: 0px; bottom: 30px;"  
            ...
            <asp:ListItem Selected="True">Sightings</asp:ListItem>
            <asp:ListItem>Birds</asp:ListItem>
            <asp:ListItem>Members</asp:ListItem>
        </asp:RadioButtonList></h3>
        <h3><asp:Label ID="Label1" runat="server" style="display: block; float:right; margin-right:150px;" Text="Records Found"></asp:Label><asp:Label ID="lRowCount" runat="server" style="display: block; float:right; " Text=""></asp:Label></h3>
    </div>
</asp:Content>
